    ...
    <div className="bg-card rounded-xl p-4 sm:p-6 border border-border overflow-hidden">
      ...
      <div className="relative min-w-0">
        <div className="w-full bg-muted rounded-full h-2 overflow-hidden">
          <div
            className="bg-gradient-to-r from-[#5a47c7] via-[#9160a8] to-[#dc9b6c] h-full rounded-full transition-all duration-700 ease-out"
        ...
        <div className="flex justify-between mt-3 gap-0.5 sm:gap-1 min-w-0">
          {milestones.map((milestone) => {
            ...
            const isActive = progressPercent >= position;
